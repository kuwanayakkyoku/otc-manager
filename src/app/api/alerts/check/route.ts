...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    const { daysLeft, formatDate } = await import("@/lib/date");
    const { LotStatus, AlertType } = await import("@prisma/client");
    ...
    for (const lot of lots) {
      ...
      let alertType: typeof AlertType[keyof typeof AlertType] | null = null;
